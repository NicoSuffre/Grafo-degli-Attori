...
// mutex 
int xpthread_mutex_init(pthread_mutex_t *__restrict mutex, const pthread_mutexattr_t *__restrict attr, int linea, char *file);
...
// barrier
int xpthread_barrier_init(pthread_barrier_t *__restrict barrier, const pthread_barrierattr_t *__restrict attr, unsigned int count, int linea, char *file);
...
// condition variables
int xpthread_cond_init(pthread_cond_t *__restrict cond, const pthread_condattr_t *__restrict attr, int linea, char *file);
int xpthread_cond_destroy(pthread_cond_t *cond, int linea, char *file);
int xpthread_cond_wait(pthread_cond_t *__restrict cond, pthread_mutex_t *__restrict mutex, int linea, char *file);
